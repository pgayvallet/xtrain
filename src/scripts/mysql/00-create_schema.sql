    ...
    create table TS_TRAINING_CAT (
        ...
        offerSiteUrl varchar(255),
        permalink varchar(255) not null,
        title varchar(255) not null,
        trainingTitle varchar(255),
    ...
    alter table TS_TRAINING_CAT 
        add index FK4ACD491D1B56FD0 (pictureFile_id), 
        add constraint FK4ACD491D1B56FD0 
