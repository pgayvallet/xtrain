...
<stripes:useActionBean var="actionBean" beanclass="fr.xebia.training.actions.admin.TrainingActionBean" event="list"/>
<c:set var="actionBeanName" value="fr.xebia.training.actions.admin.TrainingActionBean"/>
