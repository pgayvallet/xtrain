definePackage("xebia.blog", function(pkg) {
    ...
    pkg.BlogArticleCollection = Backbone.Collection.extend({
        ...
        url : function() {
            return "http://blog.xebia.fr/wp-json-api/get_category_posts/?slug=" + this.category;
        },
    ...
    pkg.BlogArticleCollectionView = Backbone.View.extend({
        ...
        render : function() {
            this.$el.empty();
            var firsts = this.collection.first(4);
